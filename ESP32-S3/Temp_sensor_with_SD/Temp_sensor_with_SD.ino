...
int logData(sensors_event_t temperature, float height, int pressure, sensors_event_t humidity){
...
/*
    ...
    */
    ...
    Serial.println(logData(temp, 10.38, 1.3, humidity));  // logData(temperature, height, pressure, humidity)  all float except pressure
